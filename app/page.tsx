...
import AnimatedArchiveCard from '@/components/AnimatedArchiveCard';
...
export default async function Home() {
  ...
  return (
    <>
      ...
      {/* Animated Archive Teaser Section */}
      <section className="py-24 bg-gradient-to-br from-slate-50 via-white to-emerald-50/30 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedArchiveCard postCount={allPosts.length} />
        </div>
      </section>
